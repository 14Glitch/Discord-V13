...
module.exports = class extends Command { //Estuturas do comandos.
    constructor(client) {
        super(client, {
            ...
            description: "Mostra sua cabeça ou a cabeça de qualquer usuário do Minecraft.", //Descrição do comando.
            options: [
                {
                    name: "nick",
    ...
    run = async(interaction) => {
        ...
        const Embed = new MessageEmbed() //Variável puxada pela const ("discord.js").
            ...
            .setDescription(`> 🧊・Clique [AQUI](https://mc-heads.net/head/${opt}) para baixar.`) //Corpo da Embed.
